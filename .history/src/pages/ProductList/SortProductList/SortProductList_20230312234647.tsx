    ...
    <div className='bg-gray-300/40 py-4 px-3'>
      <div className='flex flex-wrap items-center justify-between gap-2'>
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button
            className={classNames('h-8px-4 text-center text-sm capitalize', {
          ...
          <button
            className={classNames('h-8px-4 text-center text-sm capitalize', {
              'bg-primary text-white hover:bg-primary/80': isActiveSortBy(sortBy.soldAt),
              'bg-white text-black hover:bg-slate-100': !isActiveSortBy(sortBy.soldAt)
            })}
          >
            Bán chạy
          </button>
