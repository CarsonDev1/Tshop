          ...
          <Popover
            ...
            renderPopover={
              <div>
                <Link
                  to='/'
                  className='block w-full bg-white py-2 px-3 text-left hover:bg-slate-100 hover:text-primary'
                >
                  Tài khoản của tôi
                </Link>
                <Link
                ...
                <button className='block w-full bg-white py-2 px-3 text-left hover:bg-slate-100 hover:text-primary'>
                  Đăng xuất
                </button>
              </div>
            }
