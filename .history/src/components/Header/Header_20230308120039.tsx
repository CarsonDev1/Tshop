                ...
                <div className='relative max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                  <div className='p-2'>
                    ...
                    <div className='mt-6 flex items-center justify-between'>
                      <div className='text-xs capitalize text-gray-300'>Thêm vào giỏ hàng</div>
                      <button className='rounded-sm bg-primary px-4 py-2 capitalize text-white hover:bg-opacity-80'>
                        Xem Giỏ Hàng
                      </button>
                    </div>
                  </div>
