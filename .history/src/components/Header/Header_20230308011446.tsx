      ...
      <div className='container items-center'>
        <div className='flex justify-end'>
          ...
          <Popover
            ...
            renderPopover={
              <div>
                <Link to='/' className='block bg-white py-2 px-3 hover:bg-slate-100 hover:text-primary'>
                  Tài khoản của tôi
                </Link>
                <Link to='/' className='block bg-white py-2 px-3 hover:bg-slate-100 hover:text-primary'>
                  Đơn mua
                </Link>
                <button className='block bg-white py-2 px-3 hover:bg-slate-100 hover:text-primary'>Đăng xuất</button>
              </div>
            }
          >
